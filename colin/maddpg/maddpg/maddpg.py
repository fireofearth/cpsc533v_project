...
class MADDPG:
    def __init__(self, args, agent_id):  # 因为不同的agent的obs、act维度可能不一样，所以神经网络不同,需要agent_id来区分
        ...
        if os.path.exists(self.model_path + '/actor_params.pkl'):
            ...
            print(f"Loading parameters from: {self.model_path}")
            print('Agent {} successfully loaded actor_network: {}'.format(self.agent_id,
                                                                          self.model_path + '/actor_params.pkl'))
            print('Agent {} successfully loaded critic_network: {}'.format(self.agent_id,
                                                                           self.model_path + '/critic_params.pkl'))
        else:
            print("Using fresh parameters for actor_network, critic_network")
            print(f"Saving parameters to: {self.model_path}")
