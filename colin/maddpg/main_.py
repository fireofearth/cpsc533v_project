...
def get_args():
    ...
    parser.add_argument("--num-good", type=int, default=1, help="number of 'good' agents")
    parser.add_argument("--num-obstacles", type=int, default=1, help="number of 'good' agents")
